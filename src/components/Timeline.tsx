...
const Timeline = () => {
  const sortedMemories = memoriesData.memories.sort((a, b) => 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {sortedMemories.map((memory, index) => (
            <div key={memory.id} className={`relative flex items-center mb-12 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
              {/* Timeline dot */}
              ...
              <div className={`ml-16 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                  ...
                  <div className="mt-4">
                    <img
                      src={`https://images.unsplash.com/${memory.image}?w=400&h=250&fit=crop`}
                      alt={memory.title}
